...
import { MapPin, Star, Verified, LayoutGrid } from 'lucide-react'
...
const Details = () => {
    ...
    return (
        <PageShell>
            ...
            <PaymentMethods paymentMethods={paymentMethods} setPaymentMethods={setPaymentMethods} checkIn={checkIn} checkOut={checkOut} propertyId={id} total={property.price_per_night * nights + 500 + 800} />
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-20 flex flex-col">

                {/* Image Gallery */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-100 sm:h-150">
                    {/* Large image */}
